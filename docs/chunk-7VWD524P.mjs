...
// src/app/custom-btn.directive.ts
var _CustomBtnDirective = class _CustomBtnDirective {
  constructor(element, renderer) {
    this.element = element;
    this.renderer = renderer;
    this.CustomInputChange = new EventEmitter();
  }
  ChangeEl(event) {
    const currEl = this.element.nativeElement;
    ...
    this.Input = newEl;
    this.Input.focus();
    this.renderer.listen(newEl, "input", (event2) => {
      this.CustomInputChange.emit(event2.target.value);
    });
  }
};
_CustomBtnDirective.\u0275fac = function CustomBtnDirective_Factory(t) {
  return new (t || _CustomBtnDirective)(\u0275\u0275directiveInject(ElementRef), \u0275\u0275directiveInject(Renderer2));
};
_CustomBtnDirective.\u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({ type: _CustomBtnDirective, selectors: [["", "appCustomBtn", ""]], hostBindings: function CustomBtnDirective_HostBindings(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275listener("click", function CustomBtnDirective_click_HostBindingHandler($event) {
      return ctx.ChangeEl($event);
    });
  }
}, outputs: { CustomInputChange: "CustomInputChange" }, standalone: true });
var CustomBtnDirective = _CustomBtnDirective;

// src/app/app.component.ts
var _c0 = ["tipAmountResVal"];
var _c1 = ["totalResVal"];
var _c2 = ["tip"];
var _c3 = ["checkbox"];
...
function AppComponent_div_18_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 28)(1, "input", 29, 2);
    \u0275\u0275listener("click", function AppComponent_div_18_Template_input_click_1_listener() {
      const i_r3 = \u0275\u0275restoreView(_r2).index;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.Choose(i_r3));
    });
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const percentage_r5 = ctx.$implicit;
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275propertyInterpolate1("id", "check", ctx_r3.percentages.indexOf(percentage_r5), "");
    \u0275\u0275property("value", percentage_r5);
    \u0275\u0275advance(2);
    \u0275\u0275propertyInterpolate1("for", "check", ctx_r3.percentages.indexOf(percentage_r5), "");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(percentage_r5);
  }
}
function AppComponent_span_26_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 27);
    \u0275\u0275text(1, "Enter a valid number");
    \u0275\u0275elementEnd();
...
var _AppComponent = class _AppComponent {
  constructor(renderer, fb, document) {
    this.renderer = renderer;
    this.fb = fb;
  ...
  ngAfterViewInit() {
    this.customBox = this.document.getElementById("ClickID");
    if (this.customBox) {
      this.customBox.addEventListener("input", (event) => {
  ...
  OnInput(event) {
    if (event.key === "Enter") {
      ...
      if (this.customBox !== null) {
        if (this.customBox.value == "" || this.customBox.value == null) {
          this.ClickAway();
          return;
        }
      }
    }
    let value = this.numberPeopleField?.value;
  ...
  ClickAway() {
    const newEl = this.renderer.createElement("button");
    ...
    parent?.removeChild(this.customBox);
  ...
  calculation() {
    const tipAmount = this.totalAmount.nativeElement;
    const total = this.total.nativeElement;
    let tip;
    ...
    if (this.nbPeople != 0 && this.nbPeople != null) {
      ...
      total.innerText = ((parseFloat(tipAmount.innerText) * this.nbPeople + this.bill) / this.nbPeople).toFixed(2).toString();
    } else {
...
_AppComponent.\u0275fac = function AppComponent_Factory(t) {
  return new (t || _AppComponent)(\u0275\u0275directiveInject(Renderer2), \u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(DOCUMENT));
};
_AppComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], viewQuery: function AppComponent_Query(rf, ctx) {
  ...
  if (rf & 2) {
    let _t;
    \u0275\u0275queryRefresh(_t = \u0275\u0275loadQuery()) && (ctx.totalAmount = _t.first);
    \u0275\u0275queryRefresh(_t = \u0275\u0275loadQuery()) && (ctx.total = _t.first);
    \u0275\u0275queryRefresh(_t = \u0275\u0275loadQuery()) && (ctx.tip = _t.first);
    \u0275\u0275queryRefresh(_t = \u0275\u0275loadQuery()) && (ctx.checkboxes = _t);
  }
}, hostBindings: function AppComponent_HostBindings(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275listener("keyup", function AppComponent_keyup_HostBindingHandler($event) {
      return ctx.OnInput($event);
    }, false, \u0275\u0275resolveDocument);
  }
}, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 65, vars: 6, consts: [["tipAmountResVal", ""], ["totalResVal", ""], ["checkbox", ""], [1, "title"], [1, "container", 3, "input"], [1, "billTab"], [3, "formGroup"], [1, "input-group"], [1, "label-group"], ["class", "error", 4, "ngIf"], ["type", "number", "name", "bill", "placeholder", "0", "formControlName", "billField", 3, "ngModelChange", "change", "ngModel"], [1, "btnGroup"], ["class", "percentage", 4, "ngFor", "ngForOf"], ["id", "CustomButtonElement"], ["appCustomBtn", "", "type", "button", 1, "customBtn", 3, "click", "CustomInputChange"], ["type", "number", "name", "nbPeople", "placeholder", "1", "formControlName", "numberPeopleField", 1, "nbPeople", 3, "ngModelChange", "change", "ngModel"], [1, "calculationsTab"], [1, "calculations"], [1, "tipAmount"], [1, "tipAmountRes"], [1, "total"], [1, "totalRes"], [1, "resetBtnDiv"], [1, "resetBtn", 3, "click"], [1, "attribution"], ["href", "https://www.frontendmentor.io?ref=challenge", "target", "_blank"], ["href", "#"], [1, "error"], [1, "percentage"], ["type", "checkbox", 3, "click", "id", "value"], [3, "for"]], template: function AppComponent_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "main")(1, "div", 3);
    \u0275\u0275text(2, "SPLI");
    \u0275\u0275element(3, "br");
    \u0275\u0275text(4, "TTER");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 4);
    \u0275\u0275listener("input", function AppComponent_Template_div_input_5_listener() {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.calculation());
    });
    \u0275\u0275elementStart(6, "div", 5)(7, "form", 6)(8, "div", 7)(9, "div", 8)(10, "label");
    \u0275\u0275text(11, "Bill");
    \u0275\u0275elementEnd();
    \u0275\u0275template(12, AppComponent_span_12_Template, 2, 0, "span", 9);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "input", 10);
    \u0275\u0275twoWayListener("ngModelChange", function AppComponent_Template_input_ngModelChange_13_listener($event) {
      \u0275\u0275restoreView(_r1);
      \u0275\u0275twoWayBindingSet(ctx.bill, $event) || (ctx.bill = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("change", function AppComponent_Template_input_change_13_listener() {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.calculation());
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "div", 7)(15, "label");
    \u0275\u0275text(16, "Select Tip%");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "div", 11);
    \u0275\u0275template(18, AppComponent_div_18_Template, 5, 6, "div", 12);
    \u0275\u0275elementStart(19, "div", 13)(20, "button", 14);
    \u0275\u0275listener("click", function AppComponent_Template_button_click_20_listener() {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.Choose(5));
    })("CustomInputChange", function AppComponent_Template_button_CustomInputChange_20_listener($event) {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.OnCustomInput($event));
    });
    \u0275\u0275text(21, " Custom ");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(22, "div", 7)(23, "div", 8)(24, "label");
    \u0275\u0275text(25, "Number of People");
    \u0275\u0275elementEnd();
    \u0275\u0275template(26, AppComponent_span_26_Template, 2, 0, "span", 9);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "input", 15);
    \u0275\u0275twoWayListener("ngModelChange", function AppComponent_Template_input_ngModelChange_27_listener($event) {
      \u0275\u0275restoreView(_r1);
      \u0275\u0275twoWayBindingSet(ctx.nbPeople, $event) || (ctx.nbPeople = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("change", function AppComponent_Template_input_change_27_listener() {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.calculation());
    });
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(28, "div", 16)(29, "div", 17)(30, "div", 18)(31, "div")(32, "p");
    \u0275\u0275text(33, "Tip Amount");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(34, "span");
    \u0275\u0275text(35, "/ person");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(36, "div", 19)(37, "h1");
    \u0275\u0275text(38, "$");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(39, "h1", null, 0);
    \u0275\u0275text(41, "0.00");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(42, "div", 20)(43, "div")(44, "p");
    \u0275\u0275text(45, "Total");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(46, "span");
    \u0275\u0275text(47, "/ person");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(48, "div", 21)(49, "h1");
    \u0275\u0275text(50, "$");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(51, "h1", null, 1);
    \u0275\u0275text(53, "0.00");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(54, "div", 22)(55, "button", 23);
    \u0275\u0275listener("click", function AppComponent_Template_button_click_55_listener() {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275text(58, " Challenge by ");
    \u0275\u0275elementStart(59, "a", 25);
    \u0275\u0275text(60, "Frontend Mentor");
    \u0275\u0275elementEnd();
    \u0275\u0275text(61, ". Coded by ");
    \u0275\u0275elementStart(62, "a", 26);
    \u0275\u0275text(63, "Aziz Hmidi");
    \u0275\u0275elementEnd();
    \u0275\u0275text(64, ". ");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275property("ngIf", ctx.billField == null ? null : ctx.billField.hasError("pattern"));
    \u0275\u0275advance();
    \u0275\u0275twoWayProperty("ngModel", ctx.bill);
    \u0275\u0275advance(5);
    \u0275\u0275property("ngForOf", ctx.percentages);
    \u0275\u0275advance(8);
    \u0275\u0275property("ngIf", ctx.numberPeopleField == null ? null : ctx.numberPeopleField.hasError("pattern"));
    \u0275\u0275advance();
    \u0275\u0275twoWayProperty("ngModel", ctx.nbPeople);
  }
}, dependencies: [
  CommonModule,
  NgForOf,
  ...
  FormGroupDirective,
  FormControlName
], styles: ["\n\nmain[_ngcontent-%COMP%] {\n  overflow: hidden;\n  display: flex;\n  justify-content: space-around;\n  align-items: center;\n  flex-direction: column;\n  background-color: hsl(185, 41%, 84%);\n  height: 100vh;\n}\n.title[_ngcontent-%COMP%] {\n  font-size: 28px;\n  color: hsl(186, 14%, 43%);\n}\n.container[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-around;\n  align-items: center;\n  width: 600px;\n  height: 350px;\n  background-color: white;\n  border-radius: 10px;\n  padding: 15px;\n}\n.calculationsTab[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  flex-direction: column;\n  background-color: hsl(183, 100%, 15%);\n  border-radius: 15px;\n  padding: 40px 20px 20px 20px;\n  height: 100%;\n  width: 40%;\n}\n.billTab[_ngcontent-%COMP%] {\n  height: 100%;\n  width: 50%;\n}\n.billTab[_ngcontent-%COMP%]   form[_ngcontent-%COMP%] {\n  height: 100%;\n  display: flex;\n  justify-content: space-around;\n  align-items: stretch;\n  flex-direction: column;\n}\n.billTab[_ngcontent-%COMP%]   label[_ngcontent-%COMP%], \n.billTab[_ngcontent-%COMP%]   input[_ngcontent-%COMP%] {\n  display: block;\n}\n.input-group[_ngcontent-%COMP%]   input[_ngcontent-%COMP%] {\n  background-color: hsl(185, 41%, 84%);\n  padding: 5px 25px;\n  border: none;\n  border-radius: 5px;\n  width: 100%;\n  text-align: right;\n  background-image: url(/images/icon-dollar.svg);\n  background-repeat: no-repeat;\n  background-position-x: 10px;\n  background-position-y: center;\n  border: 2px solid transparent;\n}\n.input-group[_ngcontent-%COMP%]   input[_ngcontent-%COMP%]:hover {\n  outline: none;\n  border: 2px solid hsl(172, 67%, 45%);\n  cursor: pointer;\n}\n.label-group[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n.error[_ngcontent-%COMP%] {\n  font-size: 12px;\n  font-weight: 700;\n  color: red;\n}\n.error-border[_ngcontent-%COMP%] {\n  background-color: red;\n}\n.nbPeople[_ngcontent-%COMP%] {\n  background-image: url(/images/icon-person.svg) !important;\n}\n.tipAmountRes[_ngcontent-%COMP%], \n.totalRes[_ngcontent-%COMP%] {\n  display: flex;\n}\n.tipAmountRes[_ngcontent-%COMP%]   h1[_ngcontent-%COMP%], \n.totalRes[_ngcontent-%COMP%]   h1[_ngcontent-%COMP%] {\n  font-size: 16px;\n}\n.tipAmount[_ngcontent-%COMP%]   span[_ngcontent-%COMP%], \n.total[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  font-size: 11px;\n}\n.tipAmount[_ngcontent-%COMP%] {\n  margin-bottom: 10px;\n}\ninput[_ngcontent-%COMP%]::-webkit-outer-spin-button, \ninput[_ngcontent-%COMP%]::-webkit-inner-spin-button {\n  -webkit-appearance: none;\n  margin: 0;\n}\ninput[type=number][_ngcontent-%COMP%] {\n  appearance: textfield;\n}\n.btnGroup[_ngcontent-%COMP%] {\n  display: grid;\n  grid-template-rows: 1fr 1fr;\n  grid-template-columns: 1fr 1fr 1fr;\n  gap: 10px;\n}\n.percentage[_ngcontent-%COMP%] {\n  position: relative;\n  display: flex;\n}\n.percentage[_ngcontent-%COMP%]   input[_ngcontent-%COMP%] {\n  display: none;\n}\n.percentage[_ngcontent-%COMP%]   input[_ngcontent-%COMP%]:checked    + label[_ngcontent-%COMP%] {\n  background-color: hsl(172, 67%, 45%);\n  color: black;\n}\n.percentage[_ngcontent-%COMP%]   label[_ngcontent-%COMP%] {\n  text-align: center;\n  color: white;\n  background-color: hsl(183, 100%, 15%);\n  width: 100%;\n  border-radius: 3px;\n  padding: 5px 15px;\n  border: none;\n}\n.percentage[_ngcontent-%COMP%]   label[_ngcontent-%COMP%]:hover {\n  background-color: hsl(185, 53%, 67%);\n  cursor: pointer;\n}\n.customBtn[_ngcontent-%COMP%] {\n  border: 2px solid transparent;\n  background-color: hsl(189, 41%, 97%);\n  color: black !important;\n  text-align: center;\n  color: white;\n  cursor: pointer;\n  width: 100%;\n  border-radius: 3px;\n  padding: 5px 15px;\n}\n.ClickClass[_ngcontent-%COMP%] {\n  width: 6rem !important;\n  border-radius: 3px !important;\n  padding: 5px 15px !important;\n  border: 1px solid hsl(172, 67%, 45%) !important;\n  background-color: hsl(189, 41%, 97%) !important;\n  background-image: none !important;\n  font-size: 16px;\n  font-weight: 500;\n}\n.ClickClass[_ngcontent-%COMP%]:focus {\n  border: 1px solid hsl(172, 67%, 45%) !important;\n  outline: none;\n}\n.customBtn[_ngcontent-%COMP%]:hover {\n  border: 2px solid hsl(172, 67%, 45%) !important;\n}\n.calculations[_ngcontent-%COMP%] {\n  width: 100%;\n}\n.calculationsTab[_ngcontent-%COMP%]   p[_ngcontent-%COMP%] {\n  color: white;\n}\n.calculationsTab[_ngcontent-%COMP%]   h1[_ngcontent-%COMP%] {\n  font-size: 24px;\n}\n.calculationsTab[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  color: hsl(184, 14%, 56%);\n}\n.tipAmount[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  align-items: start;\n}\n.tipAmount[_ngcontent-%COMP%]   h1[_ngcontent-%COMP%] {\n  color: hsl(172, 67%, 45%);\n}\n.total[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  align-items: start;\n}\n.total[_ngcontent-%COMP%]   h1[_ngcontent-%COMP%] {\n  color: hsl(172, 67%, 45%);\n}\n.resetBtnDiv[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: center;\n  width: 100%;\n}\n.resetBtn[_ngcontent-%COMP%] {\n  color: black;\n  font-weight: 500;\n  background-color: hsl(172, 67%, 45%);\n  width: 100%;\n  padding: 5px 10px;\n  border-radius: 5px;\n  border: none;\n}\n.resetBtn[_ngcontent-%COMP%]:hover {\n  background-color: hsl(185, 41%, 84%);\n  cursor: pointer;\n}\n@media (max-width: 600px) {\n  .container[_ngcontent-%COMP%] {\n    width: 100%;\n  }\n}\n.calculations[_ngcontent-%COMP%]   h1[_ngcontent-%COMP%], \n.total[_ngcontent-%COMP%]   h1[_ngcontent-%COMP%] {\n  font-weight: 2000;\n  font-size: 26px;\n}\n@media (max-width: 475px) {\n  .main[_ngcontent-%COMP%] {\n    height: 100vh;\n  }\n  .title[_ngcontent-%COMP%] {\n    height: 15vh;\n  }\n  .container[_ngcontent-%COMP%] {\n    width: 100%;\n    height: 85vh;\n    align-items: center;\n    justify-content: center;\n    flex-direction: column;\n    padding: 10px 10px 0px 10px;\n    border-start-start-radius: 25px;\n    border-start-start-radius: 25px;\n  }\n  .billTab[_ngcontent-%COMP%]   form[_ngcontent-%COMP%] {\n    width: 100%;\n    display: block;\n  }\n  .input-group[_ngcontent-%COMP%] {\n    margin-bottom: 20px;\n  }\n  .billTab[_ngcontent-%COMP%] {\n    width: 90%;\n    height: 40vh;\n  }\n  .calculationsTab[_ngcontent-%COMP%] {\n    width: 90%;\n    height: 30vh;\n  }\n  .btnGroup[_ngcontent-%COMP%] {\n    grid-template-columns: 1fr 1fr;\n  }\n  .attribution[_ngcontent-%COMP%] {\n    display: none;\n  }\n  .ClickClass[_ngcontent-%COMP%] {\n    width: 100% !important;\n    text-align: center !important;\n  }\n}\n/*# sourceMappingURL=app.component-TJXVOVZQ.css.map */"] });
...
//# sourceMappingURL=chunk-7VWD524P.mjs.map
